...
<body>
	...
	<div class="home-page-main" id="home-page-main-container">
		...
		<div class="home-page-cat">
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=04">
					<img
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=01">
					<img
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=03">
					<img
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=02">
					<img
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=05">
					<img
			...
			<div class="cat_cont">
				<a
					href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=06">
					<img
	...
	<div class="text-categories-home">
		...
		<a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=04">Fresh
			Fruits</a> <a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=01">Exotic
			Fruits</a> <a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=03">Fresh
			Veggies</a> <a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=02">Exotic
			Veggies</a> <a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=05">Leafy
			Green</a> <a
			href="<%=request.getContextPath()%>/pages/product_list/list_product.jsp?cat=06">Tubers</a>
