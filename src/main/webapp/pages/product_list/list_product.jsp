...
<!-- stylesheet -->
<link rel="stylesheet"
	href="../../assets/css/base_style/product_list.css" type="text/css">
<!-- stylesheet -->

<!-- product_card stylesheet -->
<link rel="stylesheet"
	href="../../assets/css/base_style/product_card.css" type="text/css">
<!-- product_card stylesheet -->
...
<link rel="stylesheet"
	href="../../assets/css/authentication/register.css">
...
<body>
					...
					<div class="categories-main">
						...
						<ul>
							...
							<li><input type="checkbox" id="exocit-fruits"
								name="filter_cat" value="01"> <img
								src="../../assets/images/categories/exotic_fruits.png"
								alt="exotic_fruits"> <label for="exocit-fruits">Exotic
									Fruits</label></li>
							</a>

							<li><input type="checkbox" id="exocit-veggies"
								name="filter_cat" value="02"> <img
								src="../../assets/images/categories/exotic_veggies.png"
								alt="exotic_veggies"> <label for="exocit-veggies">Exotic
									Veggies</label></li>

							<li><input type="checkbox" id="fresh-veggies"
								name="filter_cat" value="03"> <img
								src="../../assets/images/categories/fresh_veggies.png"
								alt="fresh_veggies"> <label for="fresh-veggies">Fresh
									Veggies</label></li>

							<li><input type="checkbox" id="fresh-fruits"
								name="filter_cat" value="04"> <img
								src="../../assets/images/categories/fresh_fruits.png"
								alt="fresh_fruits"> <label for="fresh-fruits">Fresh
									Fruits</label></li>

							<li><input type="checkbox" id="leafy-green"
								name="filter_cat" value="05"> <img
								src="../../assets/images/categories/leafy_green.png"
								alt="leafy_green"> <label for="leafy-green">Leafy
									Green</label></li>

							<li><input type="checkbox" id="tubers" name="filter_cat"
								value="06"> <img
								src="../../assets/images/categories/tubers.png" alt="tubers">
								<label for="tubers">Tubers</label></li>
	...
	<script type="module"
		src="../../assets/js/product_curd/list_product.js"></script>

	<!-- cards appending -->

	<script type="module" src="../../assets/js/product_curd/appen_card.js"></script>
