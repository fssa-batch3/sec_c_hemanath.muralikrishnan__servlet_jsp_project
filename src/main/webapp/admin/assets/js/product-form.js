...
const seller_main_div = document.querySelector(".seller_details");
const seller_id_dropdown = document.getElementById("seller-ids");
...
function submitForm() {
	...
	axios
		...
		.then(function(getResponse) {
			...
			if (product_id == 0) {
				console.log(seller_id_dropdown.value);
				params.append("seller_id", seller_id_dropdown.value);
